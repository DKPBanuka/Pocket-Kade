...
import { Loader2, Wallet, TrendingUp, FileText, ChevronRight, Package as PackageIcon, Sparkles, Archive, Users, Undo2, Rocket } from 'lucide-react';
...
function DashboardTopProductsChart({ invoices }: { invoices: Invoice[] }) {
    ...
    const chartConfig = {
        total: { label: t('analysis.product.table.units_sold'), color: "hsl(var(--primary))" },
    };
